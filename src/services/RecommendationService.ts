  ...
  public async getRecommendations(userId?: string) {
    ...
    const consultation = await prisma.consultation.create({
      data: {
        ...
        snapshot: {
          create: {
            criteriaData: smartCriteria as any, // Simpan state kriteria
            alternativeData: smartAlternatives as any, // Simpan state nilai kecocokan
            score: results as any, // Simpan skor
            rank: detailedResults as any, // Simpan urutan akhir
          }
        }
      },
      include: {
